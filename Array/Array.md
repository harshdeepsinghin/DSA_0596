## array_without_functions_without_pointers.c
### Code
```C
#include <stdio.h>
#include <stdlib.h>
...
Query (Creation): 2
Enter the number of elements to generate randomly: 3
...
## array_without_functions_with_pointers.c
### Code
```C
#include <stdio.h>
#include <stdlib.h>
