...
int linear_search (int ARRAYPARAM[], int ARRAYSIZE, int LOWERBOUND, int UPPERBOUND, int KEY);
int binary_search (int ARRAYPARAM[], int ARRAYSIZE, int LOWERBOUND, int UPPERBOUND, int KEY);
int bubble_sort (int ARRAYPARAM[], int ARRAYSIZE, int LOWERBOUND, int UPPERBOUND);
...
{   
    ...
    int QUERY15; // input identifier for the search menu loop
    int PREV1;   // indentifier to go to previous menu (MAIN MENU)
    QUERY1 = QUERY11 = QUERY13 = QUERY134 = QUERY14 = QUERY15 = PREV1 = -1;
    ...
    int KEY = -1;           // element to find using searches
    ...
    while ( ARRAY_DECLARED != 1)
    {
        ...
        switch (QUERY1)
        {
            ...
            case 5:    // 5 - Search an element in an array
            case 6:    // 6 - Sort an array
...
// SEARCH MENU LOOP
                ...
                while ( QUERY15 != 4 )
                {
                    ...
                    switch (QUERY15)
                    {
                        case 0:    // 0 - Search Menu (this)
                            menu(15);
                            break;
                        case 1:    // 1 - Linear search
                            printf("Enter the element to search using linear method: ");
                            scanf(" %d", &KEY);
                            linear_search(ARRAY,SIZE,LB,UB,KEY);
                            break;
                        case 2:    // 2 - Binary search
                            printf("Enter the element to search using binary method: ");
                            scanf(" %d", &KEY);
                            linear_search(ARRAY,SIZE,LB,UB,KEY);
                            break;
                        case 3:    // 3 - Back to previous menu
                            PREV1 = 1;
                            break;
                        case 4:    // 4 - Exit
                            printf("\nTata! See you soon...\n\n");
...
int binary_search (int ARRAYPARAM[], int ARRAYSIZE, int LOWERBOUND, int UPPERBOUND, int KEY)
{
    bubble_sort (ARRAYPARAM[], ARRAYSIZE, LOWERBOUND, UPPERBOUND);
    int tmp, mid, low = LOWERBOUND, up = UPPERBOUND, element_found = 0;
...
int bubble_sort (int ARRAYPARAM[], int ARRAYSIZE, int LOWERBOUND, int UPPERBOUND)
{
    for ( int i = LOWERBOUND; i < UPPERBOUND; i++ )
    {
        for ( int j = LOWERBOUND; j < UPPERBOUND - i; j++ )
        {
            if ( ARRAYPARAM[j] > ARRAYPARAM[j+1] )
            {
                int tmp = ARRAYPARAM[j];
